...
<!--
    ...
    <div>
      ...
      >
        ...
        <v-btn flat color="primary" @click="selectComponent('Phenolyzer')">
          <span>Phenolyzer</span>
          <v-icon>sort</v-icon>
        </v-btn>

        <v-btn flat color="primary" @click="selectComponent('SummaryTab')">
          <span>Summary</span>
...
import GeneticTestingRegistry from './pages/GeneticTestingRegistry.vue';
import Phenolyzer from './pages/Phenolyzer.vue';
// import HomePage from './HomePage.vue';
import SummaryTab from './pages/SummaryTab.vue';
var FileSaver = require('file-saver');
import DisorderSearch from './pages/DisorderSearch.vue';
